...
export default function ProductDetailPage(){
    ...
    useEffect(() => {
        const getProduct = async () => {
          ...
          try {
            const res = await axios.get(`${BASE_URL}/v2/api/${API_PATH}/product/${product_id.id}`);
    ...
    return(
        <div className="container mt-5">
            <div className="row">
                ...
                <h5 className="mb-3">NT$ {FormatNumber(Number(product.price))}</h5>
                <div className="input-group align-items-center w-75">
                    ...
                    <button type="button" className="btn btn-primary d-flex" disabled={isLoading} onClick={()=>{
